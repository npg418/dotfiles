    ...
    keymaps = [
      {
        mode = "n";
        key = "<Leader>fs";
        action = nixvim.mkRaw "MiniPick.builtin.grep_live";
        options.desc = "Open live fuzzy finder (mini.pick)";
      }
      {
        mode = "n";
        key = "<Leader>fh";
        action = nixvim.mkRaw "MiniPick.builtin.help";
        options.desc = "Open help search (mini.pick)";
      }
      {
        mode = "n";
        key = "<Leader>fb";
        action = nixvim.mkRaw "MiniPick.builtin.buffers";
        options.desc = "Switch buffers by query (mini.pick)";
      }
      {
        mode = "n";
        key = "<Leader>ff";
        action = nixvim.mkRaw "MiniPick.builtin.resume";
